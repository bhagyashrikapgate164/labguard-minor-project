    ...
    <div class="row" >
        <div class="col-12" >
            <div class="page-header" style="margin-top:21px; padding-bottom:20px;">
                <div class="container" style="background-color:#05e649; border-radius:70px; padding-left: 40px; display: grid; margin:5px; line-height:8px;  ">
                    <h1 style="color: white;"><i class="fas fa-user-edit me-3"></i>👤 My Profile</h1>
                    <p style="color: white;">Manage your account information and settings</p>
                </div>
            </div>
        </div>
    </div>
		...
		<div class="card" ><h2>📜 Profile Information 📜</h2><hr>
			<table class="table">
				<tr><th><b>Role :-</b></th><td><b><?= $student ? 'Student' : 'Admin' ?></b></td></tr>
				<tr><th><b>Full Name :-</b></th><td><b><?= htmlspecialchars(($student ? $student['full_name'] : $admin['full_name'] )) ?></b></td></tr>
				<tr>
    <th><b>Username :-</b></th>
