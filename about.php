...
<body style="background-color:#7c3aed;">
	...
	<div class="container">
		<div class="card">
			<h3 style="margin-top:0;">About LabGuard</h3>
		...
		<div class="grid">
			<div class="card">
				<h4 style="margin:0 0 8px;">For Students</h4>
			...
			<div class="card">
				<h4 style="margin:0 0 8px;">For Admins</h4>
				<ul style="margin:0; padding-left:18px; color:var(--primary-700);">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled" >
                            <li ><i  class="fas fa-circle text-danger me-2" ></i><strong style="color: #e74c3c;">High:</strong> Safety issues, equipment damage</li>
                            <li><i class="fas fa-circle text-warning me-2"></i><strong style=" color: #f39c12;">Medium:</strong> Functional problems, minor damage</li>
                            <li><i class="fas fa-circle text-success me-2"></i><strong style="color: #27ae60;">Low:</strong> Minor issues, suggestions</li>
                        </ul>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><strong style=" color: #f39c12;">Medium Priority:</strong> Within 24 hours</li>
